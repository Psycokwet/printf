...
/*   Updated: 2020/07/21 21:42:17 by scarboni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void set_width_precision_x_up_x(t_data *datas)
{
    ...
    printf("W:%d::P:%d::L:%zu::LESS:%d\n",datas->field_width,datas->precision, datas->len, datas->active_flags & FT_PF_FLAG_LESS ? 1: 0);
}
