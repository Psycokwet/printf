...
/*   Updated: 2020/08/15 15:09:54 by scarboni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const t_write g_writer_x[MAX_WRITTER_X] = {
...
{
	return (convert(datas, MAX_SETTER_X_UP_X, SETTER_X_UP_X,
		MAX_WRITTER_X, writer_x));
}
